...
CREATE TABLE IF NOT EXISTS mssql_metadata.database_metadata (
    id        bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS mssql_metadata.schema_metadata (
    id        bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS mssql_metadata.table_metadata (
    id        bigint NOT NULL,
