...
import com.gpb.replicator.properties.LogsDatabaseProperties;
import com.gpb.replicator.properties.CleanDatabaseLogsProperties;
...
public class LogPartitionRepository {
    ...
    public void createTodayPartition() {
        ...
        String partitionName = String.format("mssql_replicator_log_%s",
                currentDate.format(DateTimeFormatter.ofPattern("yyyy_MM_dd")));

        String sql = String.format("""
                CREATE TABLE IF NOT EXISTS %s 
                PARTITION OF mssql_replicator_log 
    ...
    public void dropOldPartitions() {
        ...
        String partitionName = String.format("mssql_replicator_log_%d_%02d_%02d",
